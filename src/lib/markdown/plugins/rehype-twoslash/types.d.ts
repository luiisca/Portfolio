import type { Grammar, createStarryNight, Options as StarryNightOptions } from '@wooorm/starry-night'
import type {
    NodeCompletion,
    NodeError,
    NodeHighlight,
...
interface StarryOptions extends StarryNightOptions {
...
export interface Options {
    ...
    /**
     * Options passed to `starry-night` (optional);
     * default grammars:
     * `[sourceJson, sourceJs, sourceTsx, sourceTs]`).
     */
    starry?: StarryOptions | null | undefined
    /**
